<form action="" method="post">
        <div class="connexion">
            ...
            <div>
                <input class="inputFormulaire" type="text" name="pseudo" id="pseudo" placeholder="Pseudo" value="<?php if(isset($_SESSION["user"])) : ?><?= $_SESSION["user"]-> utilisateurPseudo?><?php endif ?>">
                <?php if(isset($messageErrorLogin['pseudo'])) : ?> <p><?= $messageErrorLogin['pseudo'] ?></p> <?php endif ?>
            </div>
            <div>
                <input class="inputFormulaire" type="text" name="mail" id="mail" placeholder="Email" value="<?php if(isset($_SESSION["user"])) : ?><?= $_SESSION["user"]->utilisateurEmail ?><?php endif ?>">
                <?php if(isset($messageErrorLogin['mail'])) : ?> <p><?= $messageErrorLogin['mail'] ?></p> <?php endif ?>
            </div>
            <div>
                <input class="inputFormulaire" type="password" name="password" id="password" placeholder="password" value="<?php if(isset($_SESSION["user"])) : ?><?= $_SESSION["user"]->utilisateurMdp ?><?php endif ?>">
